...
def evaluate(opt):
    ...
    if opt.ext_disp_to_eval is None:
        ...
        # depth_decoder =  apex.parallel.convert_syncbn_model(depth_decoder)
        ...
        with torch.no_grad():
            for data in dataloader:
                ...
                print("Downloading the pred-map")
                array_pred = np.squeeze(pred_disp)
                print(array_pred.shape)
                np.savetxt('array_pred.txt', array_pred)
